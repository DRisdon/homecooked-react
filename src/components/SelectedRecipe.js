  ...
  render() {
    return (
      <div className="selected-recipe">
        ...
        <img className="recipe-image-large" src={this.props.recipe.image_url}/><br/><br/>
        {this.props.recipe.recipe_url && <a className="button" href={this.props.recipe.recipe_url} target="_blank">See the recipe</a>}<br/><br/>
