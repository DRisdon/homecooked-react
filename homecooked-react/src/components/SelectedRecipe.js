  ...
  render() {
    return (
      <div className="selected-recipe">
        ...
        {this.props.recipe.recipe_url && <a href={this.props.recipe.recipe_url} target="_blank">See the recipe</a>}<br/>
        {this.props.recipe.name && <button onClick={this.props.addRecipe}>Add this recipe</button>}
